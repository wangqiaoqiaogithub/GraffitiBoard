...
(function (Component) {
    ...
    function addExtend(params) {
        ...
        params.prototype.vuinit = function (vutitle, vucontent) {
            var _this = this;
            var div = document.createElement('div');
            ...
            this.noticeBtn = document.getElementsByClassName('noticeBtn')[0];
            ...
            body.appendChild(div);
            console.log(this.noticeWrap)
            // _this.utilbasename.addEvent(_this.noticeWrap, "click", function () {
            //     _this.utilbasename.css(_this.noticeWrap, {
            //         "display": "none"
            //     });
            //     //_this.vnhide();
            // });
        ...
        params.prototype.vhide = function () {
            ...
            //     display: 'none'
            // })
            this.fadeOut(this.notcieWrap, 200, 10);
        };
        params.prototype.fadeOut = function (elem, speed, opacity) {
            speed = speed || 20;
...
(function (Mainpoint) {
    var MainMethods = /** @class */ (function () {
        function MainMethods(config) {
            ...
            this.step = -1;
            this.utilbasename = new utilbase.Util();
            this.component = new Component.ViewUi();
